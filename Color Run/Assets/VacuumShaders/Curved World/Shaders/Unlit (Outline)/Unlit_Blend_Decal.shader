...
Shader "Hidden/VacuumShaders/Curved World/Outline/Unlit/Opaque/Decal"
{
	Properties 
	{
	...
	SubShader 
	{
		Tags { "RenderType"="CurvedWorld_Opaque" 
		       "CurvedWorldTag"="Outline/Unlit/Opaque/Decal" 
		...
		//BASE
		UsePass "Hidden/VacuumShaders/Curved World/Unlit/Opaque/Decal/BASE"
