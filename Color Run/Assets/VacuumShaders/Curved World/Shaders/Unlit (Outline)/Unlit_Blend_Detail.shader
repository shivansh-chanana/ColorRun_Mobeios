...
Shader "Hidden/VacuumShaders/Curved World/Outline/Unlit/Opaque/Detail"
{
	Properties 
	{
	...
	SubShader 
	{
		Tags { "RenderType"="CurvedWorld_Opaque" 
		       "CurvedWorldTag"="Outline/Unlit/Opaque/Detail" 
		...
		//BASE
		UsePass "Hidden/VacuumShaders/Curved World/Unlit/Opaque/Detail/BASE"
