...
Shader "Hidden/VacuumShaders/Curved World/Outline/One Directional Light/Opaque/Vertex Alpha"
{
	Properties    
	{               
	...
	SubShader 
	{
		Tags { "RenderType"="CurvedWorld_Opaque" 
		       "CurvedWorldTag"="Outline/One Directional Light/Opaque/Vertex Alpha" 
		...
		//Base
		UsePass "Hidden/VacuumShaders/Curved World/One Directional Light/Opaque/Vertex Alpha/FORWARD"
