...
Shader "Hidden/VacuumShaders/Curved World/Outline/One Directional Light/Opaque/Detail"
{
	Properties 
	{
	...
	SubShader 
	{
		Tags { "RenderType"="CurvedWorld_Opaque" 
		       "CurvedWorldTag"="Outline/One Directional Light/Opaque/Detail" 
		...
		//Base
		UsePass "Hidden/VacuumShaders/Curved World/One Directional Light/Opaque/Detail/FORWARD"
